...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public RecyclerViewAdapter(ArrayList<Prova> lProva, ArrayList<String> lUid, ArrayList<String> lTitles, ArrayList<String> lPoints, Context context) {
        this.lTitles = lTitles;
        this.lPoints = lPoints;
        this.lProva = lProva;
        this.lUid = lUid;
        ...
        if (flag){
            ...
            viewHolder.make.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    it.putExtra("score", lProva.get(i).getScore());
